...
const EventToTable_1 = require("../Services/CallBack/EventToTable");
class Game extends GameBasicClass_1.ModelOptions {
    ...
    constructor(isLocal, Redis, HTTPS, gameBasics) {
        ...
        this.EventSender = { EventToTable: EventToTable_1.EventToTable, SendBySocketId: EventToTable_1.SendBySocketId, SendEventToUserByUserId: EventToTable_1.SendEventToUserByUserId };
    }
            ...
            try {
                ...
                if (this.options.isTableWithEntryFee === true) {
                    if (EntryFee) {
                        ...
                        let EmptyTable = yield (0, RedisAll_1.GetEmptyTableEntryfee)();
