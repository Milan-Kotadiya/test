...
const Emitter_1 = __importDefault(require("../Connections/Emitter"));
...
class Game extends GameBasicClass_1.ModelOptions {
    constructor(isLocal, Redis, HTTPS, gameBasics) {
        ...
        this.GameTimer = Emitter_1.default;
    }
    GameTimerSays(callback) {
        Emitter_1.default.on('GameTimer', (Data) => __awaiter(this, void 0, void 0, function* () {
            callback(Data);
        }));
    }
    ...
    GetTable(TableId, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const TableL = yield (0, RedisAll_1.getTable)(TableId);
                if (TableL) {
                ...
                if (this.options.isTableWithEntryFee === true) {
                    if (EntryFee) {
                        ...
                        if (EmptyTable && EmptyTable.length === 0) {
                            ...
                            const CreateTable = new TableConstructor_1.Table(NewEmptyTable, PlayerTL.UserId, this.options.GameTime, EntryFee);
                            yield (0, RedisAll_1.SetTable)(CreateTable);
                            if (this.options.isMinPlayerModeOn === true) {
                                yield (0, SitInTable_1.SitInTable)(CreateTable.id, PlayerTL.UserId, this.options.MinPlayerToStartGame, this.options.LobbyWaitTime, this.options.GameTime, this.options.RemacthWaitTime);
                            }
                            else {
                                yield (0, SitInTable_1.SitInTable)(CreateTable.id, PlayerTL.UserId, this.options.PlayersPerTable, this.options.LobbyWaitTime, this.options.GameTime, this.options.RemacthWaitTime);
                            }
                            ...
                            yield (0, RedisAll_1.AddUser)(PlayerTL.UserId, PlayerTL);
                            if (this.options.isMinPlayerModeOn === true) {
                                yield (0, SitInTable_1.SitInTable)(NewEmptyTable, PlayerTL.UserId, this.options.MinPlayerToStartGame, this.options.LobbyWaitTime, this.options.GameTime, this.options.RemacthWaitTime);
                            }
                            else {
                                yield (0, SitInTable_1.SitInTable)(NewEmptyTable, PlayerTL.UserId, this.options.PlayersPerTable, this.options.LobbyWaitTime, this.options.GameTime, this.options.RemacthWaitTime);
                            }
                    ...
                    if (EmptyTable && EmptyTable.length === 0) {
                        ...
                        PlayerTL = PlayerTL;
                        yield (0, RedisAll_1.AddUser)(PlayerTL.UserId, PlayerTL);
                        const CreateTable = new TableConstructor_1.Table(NewEmptyTable, PlayerTL.UserId, this.options.GameTime);
                        yield (0, RedisAll_1.SetTable)(CreateTable);
                        if (this.options.isMinPlayerModeOn === true) {
                            yield (0, SitInTable_1.SitInTable)(CreateTable.id, PlayerTL.UserId, this.options.MinPlayerToStartGame, this.options.LobbyWaitTime, this.options.GameTime, this.options.RemacthWaitTime);
                        }
