                ...
                if (this.options.isTableWithEntryFee === true) {
                    ...
                    if (EmptyTable && EmptyTable.length === 0) {
                        ...
                        if (this.options.isMinPlayerModeOn === true) {
                            yield (0, SitInTable_1.SitInTable)(CreateTable.id, PlayerTL.UserId, this.options.MinPlayerToStartGame, this.options.LobbyWaitTime, this.options.GameTime);
                        }
                        else {
                            yield (0, SitInTable_1.SitInTable)(CreateTable.id, PlayerTL.UserId, this.options.PlayersPerTable, this.options.LobbyWaitTime, this.options.GameTime);
                        }
